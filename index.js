...
var minProfitLoss = Number.MAX_VALUE;
var maxProfitLoss = Number.MIN_VALUE;
...
for (var i = 0; i < finances.length; i++) {
  ...
  minProfitLoss = Math.min(minProfitLoss, profitLoss);
  maxProfitLoss = Math.max(maxProfitLoss, profitLoss);

  if (i > 0) {
    var prevRecord = finances[i-1];
    var prevProfitLoss = prevRecord[1];
    var profitLossChange = profitLoss - prevProfitLoss;
    totalProfitLossChange += profitLossChange;
  }
}
